...
export default function Dependencies() {
  const dependencies = [
    ...
    },
    {
      ...
      name: "lucide-react",
      description: "Beautiful icons for portfolio UI components",
      version: "Latest",
      purpose: "UI icons",
    },
    {
      ...
      name: "tailwindcss",
      description: "Utility-first CSS framework for modern styling",
      version: "v4+",
          ...
          {dependencies.map((dep, index) => (
            ...
            >
              <CardContent className="p-6 lg:p-8 text-center">
                <div className="text-white mb-4 lg:mb-6 flex justify-center">
                  {dep.icon}
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 lg:mb-3">
                  {dep.name}
                </h3>
                ...
                <p className="text-gray-300 mb-3 lg:mb-4 leading-relaxed text-sm sm:text-base">
                  {dep.description}
                </p>
