      ...
      <div className="container mx-auto text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 mb-12 sm:mb-16 max-w-3xl mx-auto leading-relaxed px-2">
            Join developers who&apos;ve built stunning portfolios with one
            command
          </p>

          <div className="rounded-xl p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
            <div
              className="relative bg-black/90 backdrop-blur-xl mb-4 max-w-4xl border border-white/10 rounded-2xl p-3 sm:p-4 shadow-2xl hover:border-white/20 transition-all duration-300 cursor-pointer"
              onClick={(e) => {
                e.stopPropagation();
                copyToClipboard("npx create-neo-portfolio");
              }}
            >
              {/* Terminal header */}
              ...
              <div className="flex items-center justify-between overflow-x-auto">
                <div className="flex items-center space-x-2 sm:space-x-3 flex-1 min-w-0">
                  <span className="text-gray-500 font-mono text-sm sm:text-base lg:text-lg select-none flex-shrink-0">
                    $
                  </span>
