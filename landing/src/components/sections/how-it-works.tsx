            ...
            <Card className="bg-black/20 backdrop-blur-xl border-white/5 shadow-xl">
              <CardContent className="p-6 lg:p-8">
                <div className="flex items-center mb-4 lg:mb-6">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-white">1. Create Portfolio</h3>
                </div>
            ...
            <Card className="bg-black/20 backdrop-blur-xl border-white/5 shadow-xl">
              <CardContent className="p-6 lg:p-8">
                <div className="flex items-center mb-4 lg:mb-6">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-white">2. Edit Content</h3>
                </div>
                <ul className="space-y-2 lg:space-y-3 text-gray-300 text-sm sm:text-base">
                  <li className="flex items-start">
            ...
            <Card className="bg-black/20 backdrop-blur-xl border-white/5 shadow-xl md:col-span-2 lg:col-span-1">
              <CardContent className="p-6 lg:p-8">
                <div className="flex items-center mb-4 lg:mb-6">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-white">3. Deploy</h3>
                </div>
                <ul className="space-y-2 lg:space-y-3 text-gray-300 text-sm sm:text-base">
                  <li className="flex items-start">
              ...
              <CardContent className="p-6 lg:p-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-4">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h4 className="font-semibold text-white mb-2 text-sm sm:text-base">Create</h4>
                    <p className="text-gray-400 text-xs sm:text-sm">Run CLI command</p>
                  </div>
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h4 className="font-semibold text-white mb-2 text-sm sm:text-base">Edit</h4>
                    <p className="text-gray-400 text-xs sm:text-sm">Customize your data</p>
                  </div>
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h4 className="font-semibold text-white mb-2 text-sm sm:text-base">Deploy</h4>
                    <p className="text-gray-400 text-xs sm:text-sm">Launch your portfolio</p>
                  </div>
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-gray-400 text-xs sm:text-sm">Portfolio is live</p>
                  </div>
                </div>
              </CardContent>
            </Card>
